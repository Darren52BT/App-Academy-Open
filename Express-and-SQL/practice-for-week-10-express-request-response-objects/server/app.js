...
app.post("/movies", (req, res) => {
  ...
  let reqFavorite = req.body.favorite;
  let resObj = {
    id: Math.floor(Math.random() * 100),
    name: reqName ? reqName : "You need a name",
    year: reqYear ? Number(reqYear) : 2000,
    isFavorite: reqFavorite ? true : false,
  };
  res.json(resObj);
});
/**
