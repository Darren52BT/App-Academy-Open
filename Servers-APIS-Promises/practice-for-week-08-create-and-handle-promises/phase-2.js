  ...
  return new Promise( 
    (resolve, reject) =>{
      if (timeLeft < 1000){
        ...
        setTimeout( () => resolve(timeLeft - 1000), console.log("done stretching"), 1000)
      }
    }
  )
}
  ...
  return new Promise(
    (resolve, reject) =>{
      if(timeLeft < 500){
        ...
        setTimeout(() =>{
        resolve(timeLeft - 500), console.log("done running on treadmill")
      }, 500)
      }
    }
    )
    ...
    (resolve, reject) =>{
      if(timeLeft < 2000){
        reject("Error: you dont have enough time to lift weights")
          ...
          setTimeout(()=>{
        resolve(timeLeft - 2000), console.log("done lifting weights")
      }, 2000)
      }
