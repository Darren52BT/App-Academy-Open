...
const binaryToAscii = str => {
  // Your code here
  let result = "";
  //get binary string array, convert them to decimal numbers
  let binary = binaryStringToArray(str).map( (ele) => convertToBase10('0b' + ele))
  //use fromCharCode to convert each number to ASCII, join the resulting array into string
  return binary.map(ele => String.fromCharCode(ele)).join("");
