...
window.onload = () => {
  ...
  let songs = [
    "Lusitania by Andrew Bird",
    "The Blades by Squid",
    "Valleys of the Young by Andrew Bird",
    "Stars Aligned by St. Vincent",
  ];
  addList("Details about me", details);
  addList("My Activities", activities);
  addList("Some Songs I'm listening To", songs);
  addImage(
    `https://sammysworld.org/wp-content/uploads/2020/10/inrainbows-1024x770.jpg`
  );
  addClock();
  birthdayCountdown();
};
