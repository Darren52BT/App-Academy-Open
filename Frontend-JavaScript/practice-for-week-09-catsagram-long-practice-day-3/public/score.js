...
//function to get score in storage
function getScore() {
  return localStorage.getItem("score");
}
//function to set score in storage

function setScore(num) {
  return localStorage.setItem("score", num);
}
//function to restore score
