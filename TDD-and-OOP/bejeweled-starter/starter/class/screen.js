  ...
  static waitForInput() {
    ...
    process.stdin.on('keypress', function (ch, key) {
      ...
      if (!key) {
        ...
        Screen.render();
        console.log(" Yellow cursor means you are selecting the first element to swap \n Blue Cursor means you are selecting the second element to swap");
        console.log(" Red marks the current selection of the first element\n Green marks the current selection of the second element")
        Screen.printCommands();
