...
function deepDup(arr) {
  ...
  //if first element is array
  if (Array.isArray(arr[0])) {
    //make recursive call with first element
    return [deepDup(arr[0])]
  }
  //if first element isn't an array, return an array with first element and destructured 
  //results of making a recursive call on the rest of the array
