...
function intervalCount(cb, delay, amount) {
  ...
  //closes over cb, delay, and amount
  let intervalFunction = setInterval(() => {
    //call callback
    cb();
    //decrement number of times to call
    amount--;
    //if the callback has been called the required amount of times, clear the interval object
    if (amount === 0) {
