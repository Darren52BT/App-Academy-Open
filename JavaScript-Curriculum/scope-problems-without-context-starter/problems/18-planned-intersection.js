...
// your code here
//inner function closes over firstArr, filters out elements that are also in secondArr
const plannedIntersect = firstArr => secondArr => firstArr.filter((ele) => secondArr.includes(ele));
